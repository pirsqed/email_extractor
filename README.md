...
The Automator app allows you to drag and drop a file or folder onto the app, which MacOS doesn't allow with just a script. Then it saves a new CSV file to the desktop.
